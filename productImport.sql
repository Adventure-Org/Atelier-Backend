...
\COPY styles (id,productId,name,sale_price,original_price,default_style) FROM '/Users/hunny/Atelier-Backend/data/styles.csv' DELIMITER ',' CSV HEADER;
\COPY photos (id,styleId,url,thumbnail_url) FROM '/Users/hunny/Atelier-Backend/data/photos.csv' DELIMITER ',' CSV HEADER;

-- psql postgres postgres < '/Users/hunny/Atelier-Backend/productImport.sql'
-- \c [productsection]
--\COPY photos (all headers) FROM '/Users/hunny/Atelier-Backend/data/photos.csv' DELIMITER ',' CSV HEADER;  product_id int NOT NULL PRIMARY KEY,